...
# Ukazna vrstica
#
# V tej nalogi se seznanimo z ukazno vrstico v okolju Windows. Najprej
# prenesite datoteko s to nalogo in jo shranite na disk.
# =====================================================================@009826=
# 1. podnaloga
...
# smo v domači mapi. V ukazno vrstico nato vpisujemo ukaze, na primer `assoc`,
# `DriverQuery`, `exit`, `Ipconfig`, `dir` ... S katerim ukazom dobimo pregled
# nad vsebino mape, v kateri smo?
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo5ODI2LCJ1c2VyIjo3MzI0fQ:1nec2e:DrmEEMYVkFMfFegwD6UgPL25jkM'
        try:
            pass
        except:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo5ODI3LCJ1c2VyIjo3MzI0fQ:1nec2e:EU7a9ePcDE3LBTDKeaJ0xcGB7FM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo5ODI4LCJ1c2VyIjo3MzI0fQ:1nec2e:nk1Ekrcw5PC5j30J9pQDif6dJvI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0Ijo5ODI5LCJ1c2VyIjo3MzI0fQ:1nec2e:Xp7o4uOnyA2OF6zTpne405BPW3k'
        try:
    ...
    try:
        ...
        token = 'Token bce5ca6b240347abb76abb0c8e94d01f7afd8c78'
